...
class SVM(StatModel):
    ...
    def train(self, samples, responses):
        self.model.train(samples,  cv2.ml.ROW_SAMPLE, responses, params=svm_params)  # inbuilt training function
...
def trainSVM(num):
    ...
    model.train(samples, cv2.ml.ROW_SAMPLE, labels)  # features trained against the labels using svm
